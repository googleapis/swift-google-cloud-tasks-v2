...
Add `swift-google-cloud-tasks-v2` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-tasks-v2.git --from 0.0.0-preview
```

Then add `GoogleCloudTasksV2` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudTasksV2 <target-name> --package swift-google-cloud-tasks-v2
```
